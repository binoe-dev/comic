<%-- 
    Document   : comic
    Created on : Jul 22, 2020, 6:00:56 PM
    Author     : PC
--%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <%
                            ...
                            if(member!=null){
                                DatabaseConnect.addHistory(member.getIdMember(),comic.getId_comic() );
                            }
                        %>
                        <h2>Comic</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="<%= comic.getImage() %>" alt="First slide"> </div>
                ...
                <div class="row">
                        <div class="table-main table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <%
                                        List<Chapter> chapters = DatabaseConnect.getAllChapter(comic.getId_comic());
                                        ...
                                        <td class="name-pr">
                                            <form method="POST" action="ChapterServlet">
                                                ...
                                                <input type="hidden" value="<%=i.getId_Chapter()%>" name="id_chapter"/>
                                                <input type="submit" value="<%=i.getName() %>"/>
                                            </form>
