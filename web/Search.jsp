<%-- 
    Document   : Search
    Created on : Jul 26, 2020, 11:19:18 AM
    Author     : PC
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            List<Comic> comics= (List<Comic>) session.getAttribute("ResultSearch");
        %>
        <div class="main-top">
        <div class="container">
            <div class="input-group">
                ...
                <form method="POST" action="SearchServlet">
                    <input type="text" style="width: 1000px" name="search" value="<%= search %>" placeholder="Search">
        ...
        <div class="container">
            ...
            <div style="text-align: center">
                <h1 style="color: red;">Don't found any result of "<%= search %>" !!!</h1>
            <div
            <%
                }
            %>
