<%-- 
    Document   : chapter
    Created on : Jul 23, 2020, 10:40:09 AM
    Author     : PC
--%>
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <%
                            ...
                            DatabaseConnect.addViews(comic.getId_comic(), comic.getViews() + 1);
                        %>
                        <h2><%=comic.getName_comic()%></h2>
                        <ul class="breadcrumb">
                            <%
                                //  session.setAttribute("member", member);
                                comic = DatabaseConnect.getComic(comic.getId_comic());
                                session.setAttribute("comic", comic);
                            %>
                            <li class="breadcrumb-item"><a href="index.jsp">Home</a></li>
                            <li class="breadcrumb-item"><a href="comic.jsp">Comic</a></li>
        ...
        <div class="container">
            <div class="col-lg" style="text-align: center">
                ...
                <form class="prev left" method="POST" action="ChapterServlet">
                    <%
                        int id_chapter = (int) request.getAttribute("id_chapter");
                        List<Chapter> chapters = (List<Chapter>) session.getAttribute("chapters");
                        Chapter preChap = null;
                        for (Chapter i : chapters) {
                            if ((id_chapter - 1) == i.getId_Chapter()) {
                                preChap = i;
                                break;
                            }
                        }
                    ...
                    <input type="hidden" value="<%= id_chapter%>" name="id_chapter"/>
                    <%
                    } else {
                    %>

                    <input type="hidden" value="<%= comic.getId_comic()%>" name="id_comic"/>
                    <input type="hidden" value="<%= id_chapter - 1%>" name="id_chapter"/>
                    <%
                        }
                    %>

                    <input type="submit" class="fa fa-angle-left" value="Previous"/>
                </form>
                <!--                <dev class="prev left">
                                    <a class="link" href="#" style="font-size: 30px"><i class="fa fa-angle-left" ></i></a>
                                </dev>-->
                <!--<input type="submit" value="Previous"/>-->
                <form method="POST" action="ChapterServlet">
                    <input type="hidden" value="<%= comic.getId_comic()%>" name="id_comic"/>
                    <select style="font-size: 30px;width: 500px;height: 50px" name="id_chapter">
                        <%
                            for (Chapter i : chapters) {
                                if (i.getId_Chapter() == id_chapter) {
                        %>

                        <option selected="selected" style="text-align: center;" value="<%= i.getId_Chapter()%>"><%=i.getName()%></option>
                        <%
                        } else {
                        %>
                        <option style="text-align: center;" value="<%= i.getId_Chapter()%>"><%=i.getName()%></option>
                        <%
                                }
                            }
                        %>
                ...
                <form class="prev left" method="POST" action="ChapterServlet">
                    ...
                    <input type="submit" class="fa fa-angle-left" value="Next"/>
                </form>
            ...
            <div style="text-align: center">
                <ul>
                    <%
                        for (Image i : images) {
                    %>
                    <li><img src="<%=i.getLinkImage()%>" alt="<%= i.getId_Image()%>"/></li>
                        <%
                            }
                        %>
                </ul>
            ...
            <div class="col-lg" style="text-align: center">
                ...
                <form class="prev left" method="POST" action="ChapterServlet">
                    <%
                        id_chapter = (int) request.getAttribute("id_chapter");
                        chapters = (List<Chapter>) session.getAttribute("chapters");
                        preChap = null;
                        for (Chapter i : chapters) {
                            if ((id_chapter - 1) == i.getId_Chapter()) {
                                preChap = i;
                                ...
                                <p class="available-stock"><span> More than 20 available / <a href="#">8 sold </a></span><p>
                                                        ...
                                                        <div class="price-box-bar">
                                                            <div class="cart-and-bay-btn">
                                                                    <a class="btn hvr-hover" data-fancybox-close="" href="login.jsp">Follow</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="price-box-bar">
                                                            <div class="cart-and-bay-btn">
                                                                <form method="POST" action="AddFollowServlet">
                                                                <input type="submit" class="btn hvr-hover" data-fancybox-close="" value="Follow"/>
                                                                </form>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="price-box-bar">
                                                            <div class="cart-and-bay-btn">
                                                                ...
                                                                <input type="submit" class="btn hvr-hover" data-fancybox-close="" value="Unfollow"/>
                                                                </form>
                                                            </div>
                                                        </div>
