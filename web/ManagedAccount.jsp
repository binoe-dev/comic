<%-- 
    ...
    Created on : Jul 21, 2020, 10:47:02 AM
    Author     : PC
--%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Managed Account</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form action="ManagedAccountServlet" method="POST">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        User name: <p><%=member.getUsername() %></p>
...
<!--                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="subject" name="password" placeholder="password" required data-error="Please enter your password">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>-->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="tel" value="<%=member.getPhone()%>" placeholder="Phone" id="subject" class="form-control" name="phone" data-error="Please enter your phone">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="date" value="<%=member.getBirthday() %>" placeholder="Birthday" id="subject" class="form-control" name="birthday" data-error="Please enter your birthday">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
<!--                                    <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <input class="btn hvr-hover" type="submit" value="Update Account"/>
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <!--<div class="col-lg-6">-->
                            <div class="banner-frame"><img class="img-fluid" src="images/ManagedAccount.jpg" /></div>
