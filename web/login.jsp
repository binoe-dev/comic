<%-- 
    Document   : login
    Created on : Jul 19, 2020, 10:40:01 PM
    Author     : PC
--%>
...
<!--    <div class="top-search">
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="banner-frame"><img class="img-fluid" src="images/login.jpg" /></div>
                </div>
                <div class="col-lg-6" style="text-align: center">
<!--                    <h2 class="noo-sh-title-top">Login</h2>-->
<!--                    <p>"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam
					...
					<!--<a class="btn hvr-hover" href="#">Read More</a>-->
                                        <form method="POST" action="LoginServlet">
                                            <input placeholder="Username" style="height: auto; border-radius: 25px; padding: 5px; margin-bottom: 8px; font-size: 2.5vw;text-align: left; width: 100%; height: 44px; border-radius: 50px; border: solid 1px #e0e0e0; background-color: #000000; padding: 0 20px; margin-bottom: 20px; font-weight: 500; color: #ffffff;" type="text" name="username"/><br/><br/>
                                            <input placeholder="Password" style="height: auto; border-radius: 25px; padding: 5px; margin-bottom: 8px; font-size: 2.5vw;text-align: left; width: 100%; height: 44px; border-radius: 50px; border: solid 1px #e0e0e0; background-color: #000000; padding: 0 20px; margin-bottom: 20px; font-weight: 500; color: #ffffff;" type="password" name="password"/><br/><br/>
                                            <%
                                                ...
                                                if(!staticLogin){
                                                    %>
                                                    <div>
                                                        <h2 style='color: red;'>The username or password you entered is incorrect.</h2>
                                                    </div>
                                                    <%
                                                }else{}
                                                %>
                                            <input class="btn hvr-hover" style="padding: 10px 16px; font-size: 18px; line-height: 1.33; border-radius: 6px;display: inline-block;padding: 6px 12px;margin-bottom: 0;font-size: 2.5vw;font-weight: 400;line-height: 1.42857143;text-align: center;white-space: nowrap;vertical-align: middle;cursor: pointer;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;background-image: none;border: 1px solid transparent;border-radius: 4px;" type="submit" value="Log In"/><br/><br/>
                                            
                                        </form>
                                        <a style="height: auto; border-radius: 25px; padding: 5px; margin-bottom: 8px; font-size: 1.5vw; text-align: center; width: 100%; height: 44px; border-radius: 50px; padding: 0 20px; margin-bottom: 20px; font-weight: 500; color: #000000;" href="#">Forgot password</a><br/>
