<%-- 
    Document   : Register
    Created on : Jul 20, 2020, 5:57:37 PM
    Author     : PC
--%>
                    ...
                    <div class="contact-form-right">
                        ...
                        <form action="RegisterServlet" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="tel" placeholder="Phone" id="subject" class="form-control" name="phone" data-error="Please enter your phone">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="date" placeholder="Birthday" id="subject" class="form-control" name="birthday" data-error="Please enter your birthday">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
<!--                                    <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <input class="btn hvr-hover" type="submit" value="Create Account"/>
                                        <%
                                                boolean staticRegister =true;
                                                try{
                                                staticRegister =(boolean) request.getAttribute("staticRegister");
                                                }catch(Exception e)
                                                {
                                                }
                                                if(!staticRegister){
                                                    %>
                                                    <div>
                                                        <h2 style='color: red;'>The email or username had used.</h2>
                                                    </div>
                                                    <%
                                                }else{}
                                        %>
				...
				<div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <!--<div class="col-lg-6">-->
                        <div class="banner-frame"><img class="img-fluid" src="images/Register.jpg" /></div>
