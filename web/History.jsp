<%-- 
    Document   : History
    Created on : Jul 25, 2020, 3:07:55 AM
    Author     : PC
--%>
                    ...
                    <div class="col-lg-12">
                        <div class="table-main table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <%
                                        List<History> history = (List<History>) session.getAttribute("history");
...
<!--                                        <td class="quantity-box">In Stock</td>
                                        ...
                                        <td class="remove-pr">
                                            ...
                                            <form method="POST" action="RemoveHistoryServlet">
                                                <%
...
<!--         Start Instagram Feed  
        ...
        <div>
            <%
                if(!check){
                    %>
                    <h1 style='color: red; text-align: center'>Don't have history !!!!</h1>
