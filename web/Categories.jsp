<%-- 
    Document   : Categories
    Created on : Jul 25, 2020, 1:37:49 AM
    Author     : PC
--%>
        ...
        <div class="container">
            <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-search">&emsp;&emsp;</i>
                </span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <%
                            ...
                            int id_category = (int) request.getAttribute("id_category");
                            Categories category = DatabaseConnect.getCategories(id_category);
                        %>
